...
| שלב | פעולה | מבצע | משך טיפוסי | אילוץ ייבוש |
|-----|-------|-------|-----------|------------|
| Hang | תליית הקליפות על מסוע Prime | אופרטור | ~2h | — |
| Dip 1 (Prime) | טבילת ציפוי ראשון | רובוט | ~4.4h (261 דק' לאצווה מלאה) | ייבוש אחרי: **מקס׳ 6h** |
| Sand | סנדבלאסט ידני — ניקוי חול לכל 38 קליפות | אופרטור בלבד | **~60 דק'** (קשיח) | חייב להסתיים לפני Dip 2. הרובוט פנוי אך לא יכול לעשות Backup בחלון הזה (נותרות 99 דק' בלבד לפני deadline של Dip 2 — קצר מ־261 דק' של sweep) |
| Dip 2 (Prime) | טבילת ציפוי שני על Prime | רובוט | ~10h | ייבוש אחרי: **מקס׳ 6h** |
| Dip 3–7 (Backup) | חמש טבילות נוספות על Backup | רובוט | ~8h ל־dip | ייבוש בין Dips: **מינ׳ 8h** |
| Seal | ציפוי אטימה אחרון | רובוט | ~12h | ייבוש אחרי: **מינ׳ 8h** |
| Hang-dry | יבוש על הווים | פסיבי | 12h | — |
| Unhang | הורדת הקליפות מהווים לרצפה | אופרטור | ~2h | **⚠ צוואר הבקבוק של הצינור** — מהירות ה־Unhang קובעת מתי מתפנה מקום ב־Backup, שקובע מתי Prime יכול לפרוק, שקובע מתי אצווה חדשה יכולה להתחיל |
...
- `dryAfter` — "שער ייבוש" בין טבילות: הטבילה הבאה לא יכולה להתחיל עד שחלף זמן ייבוש מינימלי מהקודמת.
  - **Prime: זמן ייבוש מקסימלי 6 שעות** — אם חולפות יותר מ־6 שעות בין טבילות Prime, הציפוי מתייבש יתר על המידה והטבילה הבאה לא תידבק. זהו תקרה, לא יעד.
  - **Backup: זמן ייבוש מינימלי 8 שעות** — הציפוי חייב לאחות לפחות 8 שעות לפני טבילה חוזרת; מתחת לכך — סיכון להתקלפות. זהו רצפה, לא יעד.
- **סנדבלאסט ידני — 60 דק' קשיח** בין Dip 1 ל־Dip 2 של Prime. אופרטור בלבד; הרובוט פנוי אך חלון הזמן (99 דק') קצר מדי לריצה של Backup sweep מלא (261 דק'). לכן שלב ה־Prime הוא רצף בלתי ניתן להפרדה: ~843 דק' (261 + 60 + 261 + 261) = 14.05 שעות.
- קליפה אחת = ~₪13,000 בהכנסה פוטנציאלית (ל־KPI הכספי).

**אילוץ הצינור — Unhang כצוואר הבקבוק האמיתי:**
כאשר Prime ריק, הסיבה אינה כשל תזמון. הסיבה היא ש־Backup מלא ולא יכול לקבל את האצווה מ־Prime. Backup מתפנה רק כאשר האצווה שלפניו השלימה את כל הטבילות, התייבשה, והורדה על ידי אופרטור (Unhang). רק אז יכולה האצווה מ־Prime לעבור ל־Backup, ורק אז ניתן לטעון אצווה חדשה על Prime. הרובוט לא סרק בזמן ההמתנה הזה — הוא עבד על טבילות Backup לאצווה הקיימת. **מהירות ה־Unhang היא המשתנה התפעולי היחיד שמשפיע ישירות על קצב הצינור כולו.**
